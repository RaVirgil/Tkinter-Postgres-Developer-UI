...
class main(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for Frame in (Index, View, Create, Delete, Upload, Connection, CustomSql):
...
class Index(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button6 = ttk.Button(self, text="Custom sql", command=lambda: controller.show_frame(CustomSql))
...
class Connection(tk.Frame):
    def __init__(self, parent, controller):
        ...
        index = ttk.Button(bottom, text="Home", command=lambda: controller.show_frame(Index))
        index.pack(pady=15)


class CustomSql(tk.Frame):
    def __init__(self,parent,controller):
        tk.Frame.__init__(self,parent)
        self.console = tk.StringVar()
        bottom=tk.Frame(self)
